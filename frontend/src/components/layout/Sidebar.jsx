...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-dark-800 border-r border-gray-100 dark:border-dark-700 flex flex-col z-30 shadow-sm">
      {/* Logo */}
      ...
      <div className="px-4 py-4">
        <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-dark-900">
      ...
      {/* Bottom actions */}
      <div className="p-3 space-y-1 border-t border-gray-100 dark:border-dark-700">
        <button
          onClick={toggle}
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-dark-900 transition-all"
        >
