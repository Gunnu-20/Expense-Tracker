        ...
        <div className="bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-dark-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input name="name" value={form.name} onChange={onChange} placeholder="John Doe" required className={inputCls} />
            </div>
            <div>
            ...
            <div>
              ...
              <input name="password" type="password" value={form.password} onChange={onChange} placeholder="Min 6 characters" required minLength={6} className={inputCls} />
            </div>
